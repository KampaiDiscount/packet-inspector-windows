# Shared engine and Linux reference

This reference preserves the inherited Packet Audit engine documentation.
Its Bash, POSIX mode-bit, and systemd instructions apply to Linux only. Windows
installation, native capture, ACLs, launchers, and dashboard defaults are
documented in [WINDOWS.md](WINDOWS.md). Start at the [Windows README](README.md).
